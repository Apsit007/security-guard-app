...
// Mocks
import { mockAbsenceSummaryReport } from '../../../mocks/mockAbsenceSummaryReport';
...
const AbsenceReport:React.FC<AbsenceReportProps> = ({}) => {
  // State
  ...
  const [absenceSummaryReportData, setAbsenceSummaryReportData] = useState<AbsenceSummaryReport[]>(mockAbsenceSummaryReport);
  ...
  return (
    <section id='absence-report' className='gap-2'>
      <div className='flex flex-col gap-3'>
        ...
        <div className='flex justify-between items-end'>
          <Button
            ...
            onClick={exportToCsv}
            disabled={absenceSummaryReportData.length === 0}
          >
            Export
          </Button>
        ...
        {/* Table */}
        <TableContainer component={Paper} className={`${isAccordionOpen ? "h-[35vh]" : "h-[62vh]"}`}
          sx={{
          ...
          <Table stickyHeader>
            ...
            >
              <TableRow>
                ...
                <TableCell sx={{ minWidth: 150, textAlign: "center" }}>{"วันที่ขาดงาน"}</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {absenceSummaryReportData.map((data, index) => (
                <TableRow 
                  key={data.id} 
                  sx={{ 
                ...
                >
                  ...
                  <TableCell sx={{ borderBottom: "#FFFFFF solid 1px", color: "#133462", textAlign: "center" }}>{dayjs(data.absenceDate).format("DD/MM/BB")}</TableCell>
        ...
        {/* Footer */}
        <div className={`${absenceSummaryReportData.length > 0 ? "flex" : "hidden"} items-center justify-between pt-3 pl-1`}>
          <PaginationComponent 
            page={page} 
